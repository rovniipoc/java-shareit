...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> getAllUsersBookingByStatus(Long userId, StatusForBookingSearch state) {
        Map<String, Object> parameters = Map.of(
                "state", state.name()
        );
    ...
    public ResponseEntity<Object> getAllBookingForUserItemsByStatus(Long userId, StatusForBookingSearch state) {
        Map<String, Object> parameters = Map.of(
                "state", state.name()
        );
